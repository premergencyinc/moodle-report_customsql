...
$string['automaticallysemiannually'] = 'Scheduled, on the first day of every 6-month';
...
$string['semiannuallyheader'] = 'Semiannually';
$string['semiannually_help'] = 'These queries are automatically run on the first day of every 6-month, to report on the previous month before 6-month. These links let you view the results that has already been accumulated.';
